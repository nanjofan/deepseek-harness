...
来源：[`packages/client/connection/src/index.ts:58`](../packages/client/connection/src/index.ts)
...
- `@deepseek-ai/dsh-desktop-app` — 需要 `apiProxy` · `clientModules`（[`packages/bundle/desktop-app/src/index.ts`](../packages/bundle/desktop-app/src/index.ts)）
