...
Source: [`packages/client/connection/src/index.ts:58`](../packages/client/connection/src/index.ts)
...
- `@deepseek-ai/dsh-desktop-app` — requires `apiProxy` · `clientModules` ([`packages/bundle/desktop-app/src/index.ts`](../packages/bundle/desktop-app/src/index.ts))
